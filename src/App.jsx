        ...
        <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
          <div className="animate__animated animate__fadeInUp animate__delay-3s">
            <div className="flex items-center gap-3 mb-6 bg bg-zinc-800 w-fit p-4 rounded-2xl">
              ...
              <q>Jangan Lupa Sholat.</q>
            </div>
            <h1 className="text-5xl font-bold mb-6">
              <ShinyText text="Hi I'm Satrio Dwi Ramadhan" disabled={false} speed={3} className='custom-class' />
            </h1>
            <BlurText
              text="Pengembang aplikasi dan web yang tertarik mempelajari serta mengembangkan pengalaman digital modern dengan fokus pada performa dan kemudahan penggunaan. "
              delay={150}
              animateBy="words"
              direction="top"
              className=" mb-6"
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 pt-0 px-8" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
            <div className="basis-full md:basis-7/12 pr-0 md:pr-8 border-b md:border-b-0 md:border-r border-violet-500/30">
              ...
              <div className="flex-1 text-left">
                ...
                <BlurText
                  text="Saya Satrio Dwi Ramadhan, mahasiswa Informatika yang memiliki ketertarikan pada bidang teknologi informasi dan pengembangan sistem. Saya memiliki pemahaman dasar tentang pemrograman dan pengembangan web, serta terbiasa menggunakan komputer dan berbagai tools pendukung. Saya memiliki semangat belajar yang tinggi, bertanggung jawab, dan siap menerima arahan serta bimbingan selama proses magang untuk mengembangkan kemampuan teknis dan profesional"
                  delay={150}
                  animateBy="words"
                  direction="top"
                  className="text-base md:text-lg leading-relaxed mb-10 text-gray-300 max-w-3xl mx-auto text-center"
        ...
        <div className="kontak mt-32 sm:p-10 p-0" id="contact">
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1">
              <form
                action="https://formsubmit.co/bisniskiyo@gmail.com"
                method="POST"
